...
<table id="example" class="display nowrap" style="width:100%">
    ...
    $query=$this->db->query("SELECT * FROM foto WHERE idcotizacion='$idcotizacion'");
    foreach ($query->result() as $row){
        echo "
        <tr>
            <td>".$row->idfoto."</td>
            <td> <a href='".base_url()."$carpeta/".$row->idfoto.".jpg'> <img src='".base_url()."$carpeta/".$row->idfoto.".jpg' alt='".$row->idfoto."' width='40'></a></td>
            <td>".$row->fecha."</td>
       </tr>";
    }
    ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?=base_url()?>paciente/insertfoto" enctype="multipart/form-data" >
