...
<table id="example" class="display nowrap" style="width:100%">
    ...
    foreach ($query->result() as $row){
        ...
        <tr>
            ...
            <a href='".base_url()."Consentimientos/delete/".$row->idconsentimiento."' class='btn btn-danger sinespaciotexto btn-sm eli'>
                <i class='fa fa-trash-o '></i> Eliminar
            </a>
            <a href='".base_url()."Consentimientos/ver/".$row->idconsentimiento."' class='btn btn-info sinespaciotexto btn-sm '>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?=base_url()?>Consentimientos/insert" style="padding: 0px;margin: 0px;border: 0px">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?=base_url()?>Consentimientos/update" style="padding: 0px;margin: 0px;border: 0px">
                    <div class="form-group">
