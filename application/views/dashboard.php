...
<script src="<?=base_url()?>assets/code/modules/drilldown.js"></script>
...
<script type="text/javascript">
    ...
    Highcharts.chart('container', {
        ...
        title: {
            text: 'Cuadro de ventas por clientes'
        },
        subtitle: {
            text: 'Este cuadro muestra a los clientes que realizaron mas compras'
        },
        accessibility: {
            announceNewData: {
                enabled: true
